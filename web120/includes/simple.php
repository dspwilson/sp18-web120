...
#EDIT THE FOLLOWING:
$toAddress = "dspwilson@ohanapecosh.com";  //place your/your client's email address here
$toName = "Derek S Wilson"; //place your client's name here
$website = "ohanapecosh.com/web120";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
    ...
    <fieldset id="contact-derek"> <!-- added by Derek Wilson -->

    <legend id="contact-derek">Contact Derek</legend> <!-- added by Derek Wilson -->
